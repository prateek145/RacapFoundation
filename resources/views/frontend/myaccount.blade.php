...
<main>
    <section class="py-5 fact">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h5 class="racap-foundation">Welcome, {{auth()->user()->firstname. ' ' . auth()->user()->lastname ??
                        ""}}
                    </h5>
                    <h1 class="welcome-racap">My Account</h1>
                    <p>ID: <small>({{auth()->user()->specific_id}})</small></p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <form class="mb-3">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col">
                                    <input type="text" class="form-control mb-3" placeholder="First name"
                                        aria-label="First name" name="firstname" value="{{auth()->user()->firstname}}">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control mb-3" placeholder="Last name"
                                        aria-label="Last name" name="lastname" value="{{auth()->user()->lastname}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <input type="text" class="form-control mb-3" placeholder="Business name"
                                        aria-label="Business name" name="bname" value="{{auth()->user()->bname}}">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control mb-3" placeholder="GST Number"
                                        aria-label="GST Number" name="bname" value="{{auth()->user()->gst_no ?? ""}}">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="form-control form-selec mb-3t">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control mb-3" placeholder="State" aria-label="State"
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control mb-3" placeholder="Website"
                                        aria-label="Website" name="website" value="{{auth()->user()->website}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col d-flex">
                                    <select name="countryCode" id="" class="form-control form-select"
                                    ...
                                    <input type="number" class="form-control mb-3" placeholder="Phone"
                                        aria-label="Phone" name="phone" value="{{auth()->user()->phone}}">
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="exampleCheck1"
                                            {{auth()->user()->show_business == 'on' ? 'checked':''}}>
