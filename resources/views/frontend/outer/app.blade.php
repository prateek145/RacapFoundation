...
<body>
    ...
    @include('frontend.outer.header')
    @include('frontend.outer.c_messages')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Join as a member</h1>
                ...
                <form class="mb-3" action="{{route('register')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control mb-3" name="bname" placeholder="Business name"
                        ...
                        <div class="row">
                            ...
                            <div class="col d-flex">
                                ...
                                </select><input type="number" name="phone" class="form-control mb-3" placeholder="Phone"
                                    aria-label="Phone">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3 form-check">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1">Show my business publicly for
                                        leads.</label>
                                </div>
                            </div>
                        </div>
