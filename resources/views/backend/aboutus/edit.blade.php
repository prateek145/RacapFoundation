            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('aboutus.store') }}" method="POST"
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" id="editor1" cols="30"
                                    rows="10">{{$aboutus->description ?? ""}}</textarea>
                            ...
                            <div class="col-12 col-md-3">
                                <img src="{{asset('public/uploads/aboutus/' . $aboutus->image)}}" alt="no img"
                                    width="100%">
                            </div>
                            ...
                            <div class="col-12">
                                <label for="product" class="form-label">Upload / Replace Image</label>
